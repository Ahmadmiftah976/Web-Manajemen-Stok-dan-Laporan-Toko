        ...
        <form method="POST" action="<?= APP_URL ?>/products/store" novalidate>
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input type="text" id="name" name="name" class="form-control" placeholder="Contoh: Baju Koko Putih Polos - M" required value="<?= htmlspecialchars($_POST['name'] ?? '') ?>">
                </div>

                <!-- SKU -->
                <div class="col-md-6">
                    <label class="form-label" for="sku">SKU <span class="text-danger">*</span></label>
                    <input type="text" id="sku" name="sku" class="form-control" placeholder="Contoh: BK-PUTIH-M" required value="<?= htmlspecialchars($_POST['sku'] ?? '') ?>" style="text-transform:uppercase;">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="category" name="category" class="form-control" placeholder="Contoh: Polos, Batik, Bordir" list="category-list" value="<?= htmlspecialchars($_POST['category'] ?? '') ?>">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" id="harga_beli" name="harga_beli" class="form-control" placeholder="0" min="0" step="100" required value="<?= htmlspecialchars($_POST['harga_beli'] ?? '') ?>">
                </div>

                <!-- Harga Jual -->
                <div class="col-md-6">
                    <label class="form-label" for="harga_jual">Harga Jual (Rp) <span class="text-danger">*</span></label>
                    <input type="number" id="harga_jual" name="harga_jual" class="form-control" placeholder="0" min="0" step="100" required value="<?= htmlspecialchars($_POST['harga_jual'] ?? '') ?>">
                </div>

                <!-- Stok Minimum -->
                <div class="col-md-6">
                    <label class="form-label" for="stok_minimum">Stok Minimum</label>
                    <input type="number" id="stok_minimum" name="stok_minimum" class="form-control" placeholder="5" min="0" value="<?= htmlspecialchars($_POST['stok_minimum'] ?? '5') ?>">
                ...
                <div class="col-12">
                    ...
                    <textarea id="description" name="description" class="form-control" rows="3" placeholder="Deskripsi produk (opsional)"><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
                </div>
            </div>
